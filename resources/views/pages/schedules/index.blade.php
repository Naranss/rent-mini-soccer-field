        ...
        <table class="min-w-full text-sm text-left">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">{{ \Carbon\Carbon::parse($schedule->start_time)->format('d M Y, H:i') }}</td>
                    <td class="px-6 py-4">{{ \Carbon\Carbon::parse($schedule->end_time)->format('d M Y, H:i') }}</td>
                    <td class="px-6 py-4">
