...
<section class="p-6">
    ...
    <form action="{{ route('bookings.index') }}" method="GET" class="mb-6">
        <div class="flex items-center space-x-2">
            <input type="text" name="search" placeholder="Search by customer or field name"
        ...
        <table class="min-w-full text-sm text-left">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">{{ $booking->start_time ? date('H:i', strtotime($booking->start_time)) : '-' }}</td>
                    <td class="px-6 py-4">
                        <span
