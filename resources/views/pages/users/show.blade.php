...
@section('content')
    <div class="max-w-6xl mx-auto bg-white p-6 md:p-8 rounded-lg shadow-md font-[Poppins]">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">View Payment: {{ $payment->user->name }}</h1>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-lg font-medium text-gray-900">{{ $payment->user->name }}</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-lg text-gray-900">{{ $payment->booking->time }}</p>
            </div>
            <div>
